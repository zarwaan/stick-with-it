export default function AppName(){
    return(
        <div className="w-fit text-2xl font-[700] text-blue-900 ml-2 p-2 pl-4 pr-4 bg-blue-100 rounded-full border-blue-900 border-2 cursor-pointer flex flex-row gap-2">
